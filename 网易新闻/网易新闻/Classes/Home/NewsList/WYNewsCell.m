...
- (void)awakeFromNib {
    ...
    _replyBackgroudView.backgroundColor = [UIColor yj_colorWithHex:0xf1f1f1];
    _replyBackgroudView.layer.cornerRadius = 4;
    _replyBackgroudView.layer.masksToBounds = YES;
